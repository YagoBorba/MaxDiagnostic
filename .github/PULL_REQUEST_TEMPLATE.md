...
- [ ] My changes generate no new warnings in `flutter analyze`
...
If this PR affects the Clean Architecture structure:
...
- [ ] BLoC/Cubit state management follows project patterns
